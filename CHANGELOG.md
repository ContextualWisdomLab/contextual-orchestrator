...
- The held-out psychometric benchmark now compares the production baseline and
  ...
  Decision timing repeats 200 times per context and reports its own paired
  context-median interval, so an accuracy interval cannot silently authorize a
  slower production route.
