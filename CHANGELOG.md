...
- Declare the MIT SPDX license, packaged license file, and authoritative project URLs in distribution metadata, and pin the PEP 639-capable setuptools build backend.
