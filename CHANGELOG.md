...
- OpenRouter direct source discovery remains evidence-only, while full
  discovery promotes only exact per-model ZDR-feed matches. Paid rows also
  require current positive-credit evidence; free rows remain eligible.
