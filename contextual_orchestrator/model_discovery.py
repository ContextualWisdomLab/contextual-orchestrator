...
PROVIDER_MODEL_SOURCES: tuple[ProviderModelSource, ...] = (
    ...
    ProviderModelSource(
        ...
        capabilities=("chat",),
        # Direct source discovery remains fail-closed. ``discover_all_models``
        # may replace this per row only after an exact ZDR-feed match.
        evidence_only=True,
    ),
    ProviderModelSource(
...
def discover_all_models(
    ...
    *,
    ...
    # its public ZDR endpoint promotes only exact model matches out of the
    # source-level fail-closed state and adds route-specific privacy evidence.
