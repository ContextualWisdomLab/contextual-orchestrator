...
def migrate_legacy_categories(config_store: "ConfigStore") -> None:
...
def get_config_store(
    ...
    *,
    ...
    if not postgres_dsn:
        ...
        migrate_legacy_categories(in_memory_config_store)
    ...
    migrate_legacy_categories(config_store_adapter)
