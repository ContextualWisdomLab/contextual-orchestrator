...
class ModelClient:
    ...
    def _open_provider(self, request: urllib.request.Request) -> Any:
        ...
        return urllib.request.urlopen(  # nosemgrep: python.lang.security.audit.dynamic-urllib-use-detected.dynamic-urllib-use-detected  # nosec B310 - request URL comes from _provider_url after provider validation.
            request,
