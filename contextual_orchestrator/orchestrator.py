...
class ModelClient:
    ...
    def _build_ssl_context(ca_bundle: str | None, verify_tls: bool) -> ssl.SSLContext:
        if not verify_tls:
            return ssl._create_unverified_context()  # nosec B323 # nosemgrep: python.lang.security.unverified-ssl-context.unverified-ssl-context -- explicit dev-only provider TLS opt-out.
        if ca_bundle:
    ...
    def _open_provider(self, request: urllib.request.Request) -> Any:
        ...
        return urllib.request.urlopen(  # nosec B310 # nosemgrep: python.lang.security.audit.dynamic-urllib-use-detected.dynamic-urllib-use-detected -- URL comes from _provider_url after provider validation.
            request,
