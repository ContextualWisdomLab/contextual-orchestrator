...
class OrchestrationPolicy:
    ...
    # Role-differentiated sampling temperature (reasoning-effort proxy for Fugu/Conductor/
    # TRINITY ablation). Thinker/verifier lower for stability; worker slightly higher.
    ...
    def temperature_for_role(self, role: str) -> float:
        ...
        try:
            value = float(table.get(role, 0.2))
