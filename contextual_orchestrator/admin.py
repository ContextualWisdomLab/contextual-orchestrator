...
ADMIN_TRANSLATIONS = {
    "en": {
        ...
        "commercial_saleability_gate_title": "Commercial Saleability Gate",
        "commercial_mutual_action_plan_title": "Commercial Mutual Action Plan",
        ...
        "commercial_saleability_gate_ready": "Commercial saleability gate ready",
        "commercial_saleability_gate_ready_with_warnings": "Commercial saleability gate ready with warnings",
        "commercial_saleability_gate_blocked": "Commercial saleability gate blocked",
        "commercial_mutual_action_plan_ready": "Commercial mutual action plan ready",
        "commercial_mutual_action_plan_ready_with_warnings": "Commercial mutual action plan ready with warnings",
        "commercial_mutual_action_plan_blocked": "Commercial mutual action plan blocked",
        "readiness_pass": "Pass",
        "readiness_warn": "Warn",
        "readiness_fail": "Fail",
    ...
    "ko": {
        ...
        "commercial_saleability_gate_title": "상용 판매 가능성 Gate",
        "commercial_mutual_action_plan_title": "상용 공동 실행 계획",
        ...
        "commercial_saleability_gate_ready": "상용 판매 가능성 Gate 준비 완료",
        "commercial_saleability_gate_ready_with_warnings": "주의 조건부 상용 판매 가능성 Gate 통과",
        "commercial_saleability_gate_blocked": "상용 판매 가능성 Gate 차단",
        "commercial_mutual_action_plan_ready": "상용 공동 실행 계획 준비 완료",
        "commercial_mutual_action_plan_ready_with_warnings": "주의 조건부 상용 공동 실행 계획 가능",
        "commercial_mutual_action_plan_blocked": "상용 공동 실행 계획 차단",
        "readiness_pass": "통과",
        "readiness_warn": "주의",
        "readiness_fail": "실패",
...
Summarize this research thread and verify claims.</textarea>
  ...
  <script>
    ...
    function renderReadiness() {
      ...
      const commercialSaleabilityGate = state.commercialSaleabilityGate || {};
      const commercialMutualActionPlan = state.commercialMutualActionPlan || {};
      ...
      const saleabilityGateStatus = commercialSaleabilityGate.saleability_gate_status || "commercial_saleability_gate_blocked";
      const saleabilityGateStatusClass = saleabilityGateStatus === "commercial_saleability_gate_ready" ? "green" : saleabilityGateStatus === "commercial_saleability_gate_ready_with_warnings" ? "amber" : "red";
      const saleabilityGateSummary = commercialSaleabilityGate.gate_summary || {};
      const mutualActionPlanStatus = commercialMutualActionPlan.mutual_action_plan_status || "commercial_mutual_action_plan_blocked";
      const mutualActionPlanStatusClass = mutualActionPlanStatus === "commercial_mutual_action_plan_ready" ? "green" : mutualActionPlanStatus === "commercial_mutual_action_plan_ready_with_warnings" ? "amber" : "red";
      const mutualActionPlanSummary = commercialMutualActionPlan.plan_summary || {};
    ...
    async function refreshReadiness() {
      ...
      const commercialSaleabilityGateRes = await fetch("/api/v1/commercial_saleability_gates/latest");
      state.commercialSaleabilityGate = await commercialSaleabilityGateRes.json();
      const commercialMutualActionPlanRes = await fetch("/api/v1/commercial_mutual_action_plans/latest");
      state.commercialMutualActionPlan = await commercialMutualActionPlanRes.json();
    }
