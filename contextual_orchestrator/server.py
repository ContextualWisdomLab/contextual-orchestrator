...
def _validate_completions_temperature_top_p(body: dict[str, Any]) -> None:
    """Legacy Completions ``temperature`` ∈ [0, 2] and ``top_p`` ∈ (0, 1] when present."""
        ...
        def do_POST(self) -> None:  # noqa: N802
            try:
                ...
                if path == "/v1/completions":
                    ...
                    _validate_completions_temperature_top_p(body)
