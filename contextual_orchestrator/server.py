...
ALLOWED_COMPLETIONS_KEYS = {
    ...
    "logprobs", "n", "max_tokens", "temperature", "top_p", "stop", "user", "service_tier", "seed",
...
def _validate_completions_service_tier(body: dict[str, Any]) -> str | None:
    """Legacy Completions ``service_tier`` — auto/default no-op; other values fail closed."""
    ...
    if service_tier not in ("auto", "default"):
        raise RequestError(
            ...
            "service_tier values other than auto or default are not supported on /v1/completions",
        )
    return service_tier
        ...
        def do_POST(self) -> None:  # noqa: N802
            try:
                ...
                if path == "/v1/completions":
                    ...
                    _validate_completions_service_tier(body)
