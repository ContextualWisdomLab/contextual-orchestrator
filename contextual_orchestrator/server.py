...
def _validate_stop_sequences(body: dict[str, Any]) -> list[str] | None:
    """OpenAI ``stop`` — string or array of up to 4 non-empty strings when present."""
    if "stop" not in body:
        return None
    stop = body.get("stop")
