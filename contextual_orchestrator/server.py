...
def _validate_completions_n_choices(body: dict[str, Any]) -> int | None:
    """Legacy Completions ``n`` — positive integer; this gateway returns a single choice (n=1)."""
    if "n" not in body:
        return None
    n = body.get("n")
        ...
        def do_POST(self) -> None:  # noqa: N802
            try:
                ...
                if path == "/v1/completions":
                    ...
                    _validate_completions_n_choices(body)
