            ...
            try:
                ...
                if path == "/v1/chat/completions":
                    ...
                    if "reasoning_effort" in body:
                        # Reasoning-effort knobs (o-series style) are not mapped to provider
                        # budgets here. Accept omit; reject any value so clients cannot
                        # silently believe effort was applied.
