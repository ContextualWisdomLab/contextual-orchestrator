            ...
            try:
                ...
                if path == "/v1/chat/completions":
                    ...
                    if "service_tier" in body:
                        # OpenAI service_tier selects processing priority; this gateway has no
                        # tiered capacity plane. Accept omit / "auto" / "default" as no-ops;
                        # reject other values so SDKs cannot silently believe flex/priority applied.
                        ...
                        if service_tier not in ("auto", "default"):
                            raise RequestError(
                                400,
                                "invalid_service_tier",
                                "service_tier values other than auto or default are not supported "
