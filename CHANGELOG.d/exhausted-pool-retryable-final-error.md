...
- The final surface is now order-independent. A non-retryable last failure no longer hides an earlier retryable one, and a pool where every candidate rejected the request still reports 400. Retry/replay authorization, the circuit breaker and 413/429 handling are unchanged.
