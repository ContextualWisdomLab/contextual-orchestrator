...
`502 provider_outcome_unknown` while three other ready free-pool candidates
...
and exhausting every candidate still raises a classified `502` via
`classify_provider_failure` as before.
