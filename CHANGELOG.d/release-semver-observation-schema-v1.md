- Versioned, hash-pinned JSON Schemas (Draft 2020-12) for release SemVer
  ...
  conversion. The evidence schema accepts the ContextualWisdomLab/.github#2260
  evidence pack unchanged. This is a contract only: there is no model call
  and no version decision. contextual-orchestrator collects enumerated
