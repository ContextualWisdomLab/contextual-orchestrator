...
`a4f87f94` adds paired, seeded 2,000-resample bootstrap intervals and 200 timing
repetitions per held-out context. A same-host run reports candidate-minus-baseline Brier `[-0.0022969, -0.0016986]`,
log loss `[-0.0053736, -0.0045191]`, and regret `[-0.0072778, 0]`; candidate
p50 was 0.0194 ms versus baseline 0.0171 ms, with paired context-median latency
delta `[0.0022120, 0.0023610]` ms. This seeded simulation isolates
