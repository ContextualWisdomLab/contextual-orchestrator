...
| Sequential drift delay | Chen, Lee, and Li (2022) frame item drift monitoring as sequential change detection with compound false- and missed-detection risk. | Source `c096659b` searches 11 thresholds over 500 seeded repetitions and selects `6.1`, minimizing p95 delay among candidates meeting 5% false-alarm and 25-observation p95 targets. It records `4.8%` false alarms, p50 delay 8, and p95 delay 20, improving the prior candidate's 10/22 delays. Buyer time-series observations, risk weights, and preregistered targets remain required. |
