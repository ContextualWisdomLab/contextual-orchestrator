...
proof. Figma Code Connect is not used. Review process matches release authorization. A missing or failing snapshot is a blocker. Review delay is not a blocker only after exact-head checks, independent approval, and findings evidence pass.
