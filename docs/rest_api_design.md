...
| `GET` | `/v1/models` | OpenAI-compatible composed catalog (facade `contextual-orchestrator` plus discovered/fallback upstream models) for Noema and other `/v1` consumers |
