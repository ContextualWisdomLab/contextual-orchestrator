...
| `POST` | `/v1/batch/embeddings` | Embeddings batch; validates non-empty inputs ≤2048 (≤8192 chars each), model string, optional endpoint |  # validated: non-empty inputs ≤2048, model string, optional endpoint
