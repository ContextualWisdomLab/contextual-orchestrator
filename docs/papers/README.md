...
| Hybrid LLM (Ding et al., 2024) | Difficulty-aware small/large-model routing. | https://openreview.net/forum?id=02f3mUtqnM | The arXiv copy is marked CC BY-NC-ND 4.0; commercial repository redistribution is not assumed. |
