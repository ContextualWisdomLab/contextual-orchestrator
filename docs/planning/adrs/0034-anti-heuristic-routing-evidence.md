...
- Source commit `63877ef7` compares baseline and candidate within each held-out
  context and adds deterministic 2,000-resample paired bootstrap intervals. The
  Brier and log-loss intervals favor the candidate, but the same-host decision
  p50 did not improve (0.0213 ms candidate versus 0.0191 ms baseline); this
