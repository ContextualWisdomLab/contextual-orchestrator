...
- `contextual_orchestrator.meaning_unit_chunking`: passage-level embeddings split (Karpukhin et al., 2020; Günther et al., 2024) so naruon mail/DOM search keeps sender, paragraph, and embedded-image spans.
