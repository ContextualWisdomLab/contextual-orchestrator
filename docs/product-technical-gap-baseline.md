...
| PR | Current exact identity | Live evidence and decision |
|---:|---|---|
| [.github#1198](https://github.com/ContextualWisdomLab/.github/pull/1198) | head `94e2b28aee2029d36f272336a7cd4e4ad1516161`, base `fce028b4c3bf8e2e5e4819c1c5622e90cfa6ab39`, merge-result tree `11e0865d6aa0c24cfb6d30d84b46d44549bbd6ad` | Root security/operations PR is open, mergeable, auto-merge enabled, and protected-path blocked. It contains the `pip==26.2.1` remediation, exact CodeQL merge-ref contract, and central caller repair. Exact local evidence at the current head: `1312 passed`, statement/branch coverage `8128/3144, 100%`, interrogate `100%`, targeted actionlint, compileall, exact hash-lock pip-audit clean, CodeGraph, and diff-check clean. Hosted Checks currently show 2 success, 16 pending, 17 skipped, and 2 cancelled; independent approval remains absent. Decision: `WAIT_AND_REMEDIATE`. |
| [.github#1203](https://github.com/ContextualWisdomLab/.github/pull/1203) | head `f4161b1228bbcf4694002c324dacd1a2e2978dd7`, base `fce028b4c3bf8e2e5e4819c1c5622e90cfa6ab39`, merge-result tree `2b4228c2aed3d904907f49015788ab519f54e827` | Scheduler root repair plus the inherited #1198 dependency lock aligns repository-dispatch and metadata-free `workflow_run` concurrency with the current exact-head contract. Exact local evidence: `1309 passed`, statement/branch coverage `8128/3144, 100%`, interrogate `100%`, actionlint, shell syntax, compileall, exact hash-lock pip-audit, CodeGraph, and diff-check clean. Hosted exact-head Checks show 4 success, 16 pending, 15 skipped, and 1 cancelled, with no failure conclusion and no qualifying formal approval. Decision: `WAIT_AND_REMEDIATE`; keep normal auto-merge enabled. |
| [.github#1208](https://github.com/ContextualWisdomLab/.github/pull/1208) | head `9f0845517010f2c4695de83dd2bd50385c068a15`, base `fce028b4c3bf8e2e5e4819c1c5622e90cfa6ab39`, merge-result tree `9196a75fb362652e722fad3fc01e011c5b7c735c` | Successor to closed #1207: repairs the scanner `--output-file` contract and the v2.3.8 reporter `--output-files=sarif:results.sarif` contract, aligns stale scheduler assertions, and includes the current-main refresh. Exact local evidence: `1308 passed`, statement/branch coverage `8128/3144, 100%`, interrogate `100%`, actionlint, shell syntax, compileall, CodeGraph, and diff-check clean. Exact hash-lock pip-audit still reproduces real `pip==26.1.2 / PYSEC-2026-3721`, owned by root #1198. Hosted exact-head Checks show 16 success, 11 pending, 14 skipped, and 1 neutral; independent approval is absent. Decision: `WAIT_AND_REMEDIATE`. |
