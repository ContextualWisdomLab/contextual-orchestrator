...
| [#868](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/868) | `ce9f288e783f01df6a3447ab1de37690c1bb5901` / `main` | The moving head includes #870's conduct regression fix. Fifteen replacement hosted jobs and one unresolved review thread remain, and GitHub reports `BLOCKED`; neither earlier-head nor #870 checks transfer. Acceptance is an authenticated runtime/default check plus resolved findings, terminal hosted gates, and review on this exact head. |
