...
| --- | --- | --- |
| [#849](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/849) | `b16955b96f4ec2b7638243388053cd3e8ce659bc` | k6 measured 64 concurrent inference requests: 128/128 inference and 100/100 health requests succeeded with 0/228 HTTP failures at 25.068 inference req/s and 10.85 ms health p99. HTTP/1.1 persistence plus native `socket.SOMAXCONN` raised the initial measured inference rate by 54.61%; the exact-head security repair closes connections whenever a rejected request body remains unread, preventing persistent-stream desynchronization. Independent review and protected checks remain pending with auto-merge enabled. |
...
| [#834](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/834) | `c146d1eec96e478be5054a2bca48f3bfcaaac46f` | Contains the reviewed #847 remediation, a model-group fetch failure guard for the admin console, and the hourly loop's explicit PRD plus measured-k6 requirement; independent exact-head review and protected checks are pending with auto-merge enabled. This is not protected-main evidence yet. |
