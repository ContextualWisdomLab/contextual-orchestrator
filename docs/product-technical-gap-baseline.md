...
| P2 | Frontend component inventory is not applicable here. | Policy updated: React and Storybook will be embedded into this repository for the Web Admin. | Initialize a React+Storybook tree, adhere to accessibility/responsive standards, and serve it from the Python backend. |
