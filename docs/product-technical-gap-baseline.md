...
| [#868](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/868) | `37dd6193e893fcf9e196afd6ac859b4e544e18af` / `main` | The moving head now includes the normally merged #870 conduct regression fix and #874 configured-gateway discovery stack. Sixteen replacement hosted jobs remain, no review threads are unresolved, and GitHub reports `BLOCKED`; child-PR checks do not transfer. The absorbed gateway change still requires removal of runtime environment-secret promotion, reuse of the hardened credentialed provider-egress boundary, and capability consensus across heterogeneous deployments before authenticated runtime/default evidence, terminal hosted gates, and review on this exact head can establish acceptance. |
...
| [#874](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/874) | `12a2c55c227e41cc0f28dc235da65aef1351aee4` / `fix/gateway-default-chat-model` | Merged normally into stacked base #868 as `37dd6193e893fcf9e196afd6ac859b4e544e18af`, not into protected `main`. The latest commit only normalized bootstrap-secret whitespace; pricing consensus is fixed, while runtime environment-secret promotion, hardened credentialed provider egress, and heterogeneous-deployment capability consensus remain open on #868. Acceptance therefore follows #868's current exact head and a post-protected-merge authenticated catalog check. |
