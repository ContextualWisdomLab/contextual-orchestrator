...
| [#834](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/834) | `5ecdd3f541a1826875712051c2b4b67df8ed387c` | Contains the reviewed #847 remediation, validates throughput evidence before mutating routing state, binds external-PR validation to the fetched exact head, and keeps ADR references/API paths current; independent exact-head review and protected checks are pending with auto-merge enabled. This is not protected-main evidence yet. |
