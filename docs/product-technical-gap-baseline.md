...
| PR | Current exact identity | Live evidence and decision |
|---:|---|---|
| [.github#1198](https://github.com/ContextualWisdomLab/.github/pull/1198) | head `3a6c170deb15d19521bb10c30aa3839f789eb92f`, base `6a79f075d62b5f8dcfef6145960f1c42c147f273` | Root security/operations PR is open, mergeable, auto-merge enabled, and protected-path blocked. The earlier `PYSEC-2026-3721` lock finding is remediated at `pip==26.2.1`; the missing `FakeClient.__init__` docstring was added. Exact local evidence: `1297 passed`, statement/branch coverage `100%`, interrogate `100%`, targeted actionlint, compileall, exact hash-lock pip-audit clean. Hosted Checks currently show 24 success, 3 neutral, 14 skipped, and 2 pending; independent approval remains absent. Decision: `WAIT_AND_REMEDIATE`. |
| [.github#1203](https://github.com/ContextualWisdomLab/.github/pull/1203) | head `5ae2808b4e4397c155073e7094f8799960692c46`, base `6a79f075d62b5f8dcfef6145960f1c42c147f273`, merge-result tree `912660976e825ba55edd7e5ed65dfcd746765295` | Scheduler root repair plus current-head documentation aligns the quick-gate contract with repository-scoped `repository_dispatch` and metadata-free `workflow_run` concurrency, preventing current-main exact-head policy failures. Exact local evidence: `1294 passed`, statement/branch coverage `100%`, interrogate `100%`, targeted actionlint, shell syntax/contract checks, compileall, full `test_strix_quick_gate.sh: PASS`, CodeGraph, and diff-check clean. Hosted exact-head checks currently show 24 success, 3 neutral, 22 skipped, 3 cancelled, 2 pending, and one real inherited `pip-audit` failure for `pip==26.1.2 / PYSEC-2026-3721`; root #1198 carries the `26.2.1` remediation. Independent approval is absent. Decision: `WAIT_AND_REMEDIATE`. |
| [.github#1208](https://github.com/ContextualWisdomLab/.github/pull/1208) | head `de2ea4b9d7c8bcca81a69834d6d1859bfd9425ed`, base `6a79f075d62b5f8dcfef6145960f1c42c147f273`, merge-result tree `9fe2758e5cb283996f4b19c6dd39a06800d03589` | Successor to closed #1207: repairs the scanner `--output-file` contract and the v2.3.8 reporter `--output-files=sarif:results.sarif` contract, aligns stale scheduler assertions, and completes the two docstring-gate entries exposed by exact local verification. Exact local evidence: `1293 passed`, statement/branch coverage `100%`, interrogate `100%`, targeted contract `52 passed`, actionlint, shell syntax, compileall, CodeGraph, and diff-check clean. The previous reporter failure is repaired; fresh exact-head hosted Checks show 4 success, 2 cancelled, 17 skipped, and 16 pending, with no failure yet; independent approval is absent. The inherited `pip==26.1.2` advisory remains the root #1198 dependency concern. Decision: `WAIT_AND_REMEDIATE`. |
| [.github#1206](https://github.com/ContextualWisdomLab/.github/pull/1206) | head `d51638c11c5da1b30dd1867ecd019fd0dd28eb92`, base `3a6c170deb15d19521bb10c30aa3839f789eb92f` on `fix/pip-audit-pip-2621` | CodeQL follow-up is normally restacked onto the current #1198 root. Exact local evidence: focused CodeQL contract `3 passed`, full suite `1297 passed`, statement/branch coverage `100%`, interrogate `100%`, actionlint/compileall/CodeGraph/diff-check clean. Hosted checks restarted and are queued; independent approval is absent. Decision: `WAIT_AND_REMEDIATE`. |
| [.github#1153](https://github.com/ContextualWisdomLab/.github/pull/1153) | head `9002f4db34128db80916c703957bb25e3ba4163e`, base `6a79f075d62b5f8dcfef6145960f1c42c147f273` | The prior hosted `pip-audit` failure was reproduced as real `PYSEC-2026-3721` in `pip==26.1.2`; the source input and regenerated hash lock now resolve `pip==26.2.1`. Exact local evidence: `1306 passed`, statement/branch coverage `100%`, interrogate `100%`, exact-lock pip-audit clean, compileall/diff-check clean. The latest hosted path failure is the known stale scheduler contract assertion, while the other runs were superseded/cancelled; fresh evidence must follow #1208, and independent approval is absent. Decision: `WAIT_AND_REMEDIATE`. |
...
|---:|---|---|
| [#804](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/804) | head `f74cfc071c73706f93ce0d7d33f7421459b6a11f`, base `e226e1197bdfc890c9d8e5b9b648c78857d7e465` | Open and mergeable but blocked; current checks show 18 success, 2 neutral, 7 skipped, with coverage and Strix pending; auto-merge is disabled and formal approvals `0`. Prior local evidence does not transfer after this head advanced. Decision: `WAIT_AND_REMEDIATE`. |
| [#807](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/807) | head `f832e32f99886388188e5b1f0d89c47ce4cfeef8`, base `e226e1197bdfc890c9d8e5b9b648c78857d7e465` | Open and mergeable but blocked; current checks show 19 success, 2 neutral, 8 skipped, with coverage pending; auto-merge enabled and formal approvals `0`. Prior local evidence does not transfer after this head advanced. Decision: `WAIT_AND_REMEDIATE`. |
| [#818](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/818) | head `51531d0c1144427c67649da3233bcbe1c5d53858`, base `e226e1197bdfc890c9d8e5b9b648c78857d7e465` | Open and mergeable but blocked; current checks show 12 success, 2 neutral, 9 skipped, 1 `osv-scan` failure, and coverage/Strix pending. The failure reproduces the central workflow's deprecated OSV `--output` contract and is independent of this OTEL diff; central #1208 now carries the reporter/scanner repair. Formal approvals `0`. Decision: `WAIT_AND_REMEDIATE`; restack and rerun after the central repair lands. |
...
| [#820](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/820) | head `a92d524abc8bdee26a2e546f6ec2dab6f7a04204`, base `e226e1197bdfc890c9d8e5b9b648c78857d7e465` | Open and mergeable but blocked; current checks show 14 success, 2 neutral, 10 skipped, 1 `osv-scan` failure, and coverage pending. The failure is the same inherited central OSV `--output` contract, not this sampling-default diff; formal approvals `0`. Decision: `WAIT_AND_REMEDIATE`; restack and rerun after central #1208. |
