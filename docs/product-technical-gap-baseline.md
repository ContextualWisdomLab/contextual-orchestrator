...
| PR | Current exact identity | Live evidence and decision |
|---:|---|---|
| [.github#1198](https://github.com/ContextualWisdomLab/.github/pull/1198) | head `3b91220405a2434f5b16bc336bf12b871bb374a1`, base `0156282022134484ea9d7541d5ba0730ba14fd96`, merge-result tree `c26763be08777940416a3679c9dca4e5f37ebced` | Current root includes external-head rejection hardening in privileged review paths. Exact local evidence on the identical tree: `1351 passed`, statement/branch coverage `8280/3230, 100%`, interrogate `100%`, compileall, scheduler actionlint, shell syntax, exact hash-lock pip-audit, and diff-check clean. Full `opencode-review-dispatch.yml` actionlint timed out at the bounded 60-second limit and is not claimed as passed. Hosted rollup is 2 success, 19 skipped, 22 cancelled, and 2 queued/in-progress; independent approval remains absent. Decision: `WAIT_AND_REMEDIATE`. |
...
| [.github#1187](https://github.com/ContextualWisdomLab/.github/pull/1187) | head `be6534b4e04d0856f31c732c1eff84a2aacd269e`, base `fce028b4c3bf8e2e5e4819c1c5622e90cfa6ab39`, head tree `024a96f1f4d4d90e38c2872b17fc3ad3c755468e` | Exact-head docstring repair remains locally verified with `1312 passed`, statement/branch coverage `8144/3154, 100%`, interrogate `100%`, compileall, shell syntax, exact hash-lock pip-audit, and diff-check clean. The PR is now `CONFLICTING` because protected main advanced to `01562820`; head-only evidence does not prove the new merge-result tree. Hosted rollup is 7 success, 23 skipped, and 21 cancelled; no qualifying approval exists. Decision: `WAIT_AND_REMEDIATE` pending normal restack and fresh merge-result validation. |
| [.github#1188](https://github.com/ContextualWisdomLab/.github/pull/1188) | head `2c05f05f5fbb923099e0e228d616ab9974dbd327`, base `0156282022134484ea9d7541d5ba0730ba14fd96`, head tree `6c19376c4a030eb97a9d4b7f6a2a0b85d38740a3` | The head advanced with a main-refresh merge after the prior OIDC validation, so the prior `1308 passed` merge-result evidence is stale. Hosted rollup is 7 success, 15 skipped, 1 cancelled, and 16 queued/in-progress; no qualifying approval exists. Decision: `WAIT_AND_REMEDIATE` pending current-head verification and terminal required Checks. |
| [.github#1189](https://github.com/ContextualWisdomLab/.github/pull/1189) | PR API head `6ffdcc3f0c96610295d143a3f54f3821b3a23ec9`, base `fce028b4c3bf8e2e5e4819c1c5622e90cfa6ab39`, head tree `798f45a3de691f41b83a7edd241143e15bd6d035` | The PR is `CONFLICTING` after protected main advanced to `01562820`. A normal merge-restack commit `12c7d513` was pushed to the named branch, but the PR API still reports head `6ffdcc3f`; therefore the restack is not treated as current PR evidence. Prior local head evidence was `1308 passed`, coverage/interrogate 100%, compileall, shell syntax, pip-audit, and diff-check clean. Hosted rollup is 32 success, 21 skipped, 3 neutral, and 1 queued; no qualifying approval exists. Decision: `WAIT_AND_REMEDIATE`. |
...
| [#820](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/820) | head `4959e805c5724e7d1620639ab0151a992d717a0c`, base `e226e1197bdfc890c9d8e5b9b648c78857d7e465`, merge-result tree `7425bf1eed13fe2fd6c49fe8ce8df4bf85412783` | Open and mergeable but blocked; hosted `osv-scan` is failed and `opencode-review` is queued. The OSV scanner exited `0`, then the inherited workflow postcondition failed because empty output files were required to be non-empty; this is not evidence that the sampling-default diff is safe to merge. Formal approvals `0`; decision `WAIT_AND_REMEDIATE`. |
