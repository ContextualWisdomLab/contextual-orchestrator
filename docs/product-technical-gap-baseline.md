...
| [#834](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/834) | `5ecdd3f52a97bdec40ab7acab958ae5aa4d40c89` | Contains the reviewed #847 remediation, validates throughput evidence before mutating routing state, binds external-PR validation to the fetched exact head, and keeps ADR references/API paths current; independent exact-head review and protected checks are pending with auto-merge enabled. This is not protected-main evidence yet. |
