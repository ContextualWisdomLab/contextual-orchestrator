...
**As of:** 2026-08-21 09:12, Asia/Seoul
...
| [#796](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/796) | `59da6d0ddecec5a689bb3fc0a69ba5c292bfd448` | ready, based on [#795](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/795) | Cost-ledger normalization separates execution facts from attribution dimensions, keeps migration transactional, enables SQLite foreign keys before schema work, selects PostgreSQL metadata through the driver-native path, and maps nullable legacy attribution to `unattributed` before `NOT NULL` insertion. Exact-head proof is full `1452 passed in 523.70s`, compileall, and diff-check clean; it includes static migration SQL, explicit SQLite transaction start, seeded-catalog rollback, FK enforcement/cascade, PostgreSQL metadata selection, and qualified SQL naming coverage. Hosted Checks and independent approval remain required. |
...
observed at 2026-08-21 09:12 Asia/Seoul; they are evidence pointers, not
standing approval.
