...
| [#805](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/805) | `3a60530c886f7db8fc3b7fb70341247dde8985b0` | open, based on `fix/auto-reasoning-effort-contract-rebased` at `f1b0cd48271e870571b022463e1ec2c857ae4a8a`; hosted Checks queued at snapshot | Structured provider-feature orchestration repair. A concurrent agent advanced the head after the prior local proof; the earlier `1448 passed` evidence belongs to predecessor `02e306d9` and is not transferable. Re-run full exact-head verification on `3a60530c` before merge; independent approval remains required. |
