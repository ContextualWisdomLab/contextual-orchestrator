...
| #785 | `6609a51` | ready, based on main | Issue #568 implementation: exact local full suite `1460 passed`, focused profile/fuzz suite `35 passed`; hosted Checks are queued and independent approval is required. |
| #773 | `193164b` | ready, based on main | Review this dated baseline and ADR 0016 against the exact heads in this table; it has no independent approval yet. |
