...
**As of:** 2026-08-21 03:39, Asia/Seoul
...
| [#784](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/784) | `6bceb558c72beb6d680141b85008d31d693a77de` | ready, based on main | Review fail-closed release authorization, exact-head `gh api` collection, product-evidence separation, and fresh hosted Checks before protected merge; the collector check is directly runnable and focused tests pass. |
...
| [#765](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/765) | `2ab9b9f011403bcea7ee812c5b5b389ddebe1181` | draft, based on main | Current parent includes merged #778 at merge commit `0a3ab0b901d0b39d610f26538243bb5b3c1b3c61`, the merged #779 temperature-negotiation stack at `a4e9a780a56c08e131367f3b904f5c855b3a1b33`, the complete-body-at-deadline fix, and the virtual-model embedding-capability gate fix. Fresh exact-head local proof is `1510 passed in 611.33s`; Ruff, compile, and diff checks are clean. Reconcile after [#768](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/768)/[#769](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/769) and obtain current hosted approval/Checks. |
...
observed at 2026-08-21 03:39 Asia/Seoul; they are evidence pointers, not
standing approval.
