...
**As of:** 2026-08-21 10:10, Asia/Seoul
...
| [#800](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/800) | `365442be60ec6da311d992ddaa69e2bfe2ab1a8a` | ready, stacked on [#789](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/789) | Explicit `argv` injection lets LineageWeave invoke the CLI without mutating process arguments; the current #789 stack was reconciled before validation. Exact-head proof is `50 passed` across CLI/API, discovery, embedding, and security suites, with Ruff/compileall/diff-check clean. Hosted Checks and independent approval remain required. |
