...
**As of:** 2026-08-21 03:33, Asia/Seoul
...
| [#789](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/789) | `930bce1193d557f6dfe4252ef3187efb47dde194` | ready, based on main | Current head removes stale direct-entry calls, duplicate fixture keys, and an unused import from the embedding contract tests. Focused proof is `131 passed`; exact full proof is `1441 passed in 545.70s`; hosted Checks are freshly queued after this push and protected independent approval remains required. |
...
| [#784](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/784) | `6bceb558c72beb6d680141b85008d31d693a77de` | ready, based on main | Current head adds a direct collector entry-point contract on top of the fail-closed release-authority path. Previous `f29ae25` proof is stale; hosted Checks are freshly queued and must be revalidated at `6bceb558` before protected merge. |
...
| [#765](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/765) | `2ab9b9f011403bcea7ee812c5b5b389ddebe1181` | ready, based on main | Promoted from draft after the parent stack was reconciled. The current head supersedes the earlier `0a3ab0b9` local proof; hosted Checks are freshly queued and exact-head review/independent approval are still required before protected merge. |
...
observed at 2026-08-21 03:33 Asia/Seoul; they are evidence pointers, not
standing approval.
