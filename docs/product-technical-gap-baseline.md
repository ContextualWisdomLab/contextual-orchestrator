...
| [#874](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/874) | `12a2c55c227e41cc0f28dc235da65aef1351aee4` / `fix/gateway-default-chat-model` | Merged normally into stacked base #868 as `37dd6193e893fcf9e196afd6ac859b4e544e18af`, not into protected `main`. Its three remaining environment-secret, provider-egress, and heterogeneous-capability gaps are fixed only by descendant #868 exact `90cca8b531ed4e174fce13339e848466aced364a`; child closure does not establish protected delivery. Acceptance follows #868's current exact-head gates and post-protected-merge authenticated catalog check. |
