...
**As of:** 2026-08-20 23:48, Asia/Seoul
...
| [#785](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/785) | `21cb3e5bc0f2f607a539796fcfceef5cfb4799d1` | ready, based on main | Issue [#568](https://github.com/ContextualWisdomLab/contextual-orchestrator/issues/568) exact-head proof is full suite `1460 passed in 595.03s`, focused passthrough/profile/tool suite `52 passed`, direct passthrough regression `11 passed`, and Ruff/diff clean; independent approval and protected Checks remain required. |
