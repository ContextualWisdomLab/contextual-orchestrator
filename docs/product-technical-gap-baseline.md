...
**As of:** 2026-08-21 07:18, Asia/Seoul
...
| [#763](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/763) | `f72fd043e01d57656b4d08bf9c03eb95d834501d` | dirty, based on [#765](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/765) at predecessor `2ab9b9f011403bcea7ee812c5b5b389ddebe1181` | Current stack integrates #765 and #768 gateway/capability boundaries with one-shot local Responses translation, local concurrency coordination, concrete-model stickiness, adaptive provider failover, and an embedding-specific capability filter that admits real embedding identifiers without weakening chat routing. Local proof is focused `32 passed`, full `1589 passed`, and changed-area static checks pass, but the parent moved to `ba8b4b8ab181bcd2c64b871d0984006452e4c753`; refresh the child base and rerun Checks before protected merge. |
...
observed at 2026-08-21 07:18 Asia/Seoul; they are evidence pointers, not
standing approval.
