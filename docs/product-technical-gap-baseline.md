...
**As of:** 2026-08-21 09:32, Asia/Seoul
...
| [#794](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/794) | `48a8c79481ebf42749418c7b1d93d8553c9fb4b7` | ready, based on main | Database naming repair renames the single-word state table to `orchestration_records`, preserves legacy rows through an atomic fail-closed migration, uses static migration DDL to satisfy SQL-safety scanning, closes the connection on schema failure, and covers qualified and quoted database-object declarations. Exact-head persistence/naming proof is `13 passed`, compileall and diff-check clean; the previous full-suite evidence belongs to a predecessor head. Hosted Checks and independent approval remain required. |
...
| [#784](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/784) | `df559f8e995d8fb0aa38cee8eb5722a946dad061` | ready, stacked on `fix/issue-117-workflow-object-authorization` | Current head preserves the release-authority and product-blocker separation and adds a one-line documentation correction to keep snapshot checks on the pytest path. Prior focused/full evidence belongs to predecessor `f1f3b0927d6938f6b8b71f9b1551e9fa6ecdcb02`; rerun protected current-head Checks before merge. |
...
observed at 2026-08-21 09:32 Asia/Seoul; they are evidence pointers, not
standing approval.
