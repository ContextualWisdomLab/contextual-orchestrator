...
| PR | Current exact identity | Live evidence and decision |
|---:|---|---|
| [.github#1198](https://github.com/ContextualWisdomLab/.github/pull/1198) | head `4d3d24aa404959f5067735fec0558d5924ade590`, base `fce028b4c3bf8e2e5e4819c1c5622e90cfa6ab39`, merge-result tree `1fb863e1145966d8ca5c881af3fd2fbd39e8c1cf` | Root security/operations PR now includes the normally consolidated scheduler repair and the `pip==26.2.1` lock repair. Exact local evidence on the identical tree: `1313 passed`, statement/branch coverage `8128/3144, 100%`, interrogate `100%`, targeted actionlint, compileall, exact hash-lock pip-audit clean, shell syntax, and diff-check clean. Latest hosted rollup is 30 success, 19 skipped, 3 neutral, 1 cancelled, and 2 queued; independent approval remains absent. Decision: `WAIT_AND_REMEDIATE`. |
| [.github#1203](https://github.com/ContextualWisdomLab/.github/pull/1203) | head `c627d4ae7a26222ed3d2ee1ded19e270930aa1f2`, base `94e2b28aee2029d36f272336a7cd4e4ad1516161` on `fix/pip-audit-pip-2621`, merge-result tree `1fb863e1145966d8ca5c881af3fd2fbd39e8c1cf` | Scheduler repair is normally restacked on the #1198 root. The live writer's tree matches the locally verified restack tree: `1313 passed`, statement/branch coverage `8128/3144, 100%`, interrogate `100%`, targeted actionlint, compileall, exact hash-lock pip-audit, shell syntax, and diff-check clean. Latest hosted rollup is 9 success, 13 skipped, 10 cancelled, and 1 queued; mergeability is currently `UNKNOWN` and no qualifying formal approval exists. Decision: `WAIT_AND_REMEDIATE`. |
| [.github#1208](https://github.com/ContextualWisdomLab/.github/pull/1208) | head `9f0845517010f2c4695de83dd2bd50385c068a15`, base `fce028b4c3bf8e2e5e4819c1c5622e90cfa6ab39`, merge-result tree `9196a75fb362652e722fad3fc01e011c5b7c735c` | Successor to closed #1207: repairs the OSV output contracts and aligns stale scheduler assertions. Exact local evidence: `1308 passed`, statement/branch coverage `8128/3144, 100%`, interrogate `100%`, actionlint, shell syntax, compileall, CodeGraph, and diff-check clean. Exact hash-lock pip-audit still reproduces real `pip==26.1.2 / PYSEC-2026-3721`, a source dependency failure owned by root #1198. Latest hosted rollup is 38 success, 35 skipped, 9 cancelled, 3 neutral, 1 failure (`pip-audit`), and 1 queued; independent approval is absent. Decision: `WAIT_AND_REMEDIATE`. |
| [.github#1187](https://github.com/ContextualWisdomLab/.github/pull/1187) | head `be6534b4e04d0856f31c732c1eff84a2aacd269e`, base `fce028b4c3bf8e2e5e4819c1c5622e90cfa6ab39`, merge-result tree `024a96f1f4d4d90e38c2872b17fc3ad3c755468e` | Exact-head docstring repair added the two missing `__init__` docstrings; local evidence is `1312 passed`, statement/branch coverage `8144/3154, 100%`, interrogate `100%`, compileall, shell syntax, exact hash-lock pip-audit, and diff-check clean. Latest hosted rollup is 7 success, 23 skipped, and 21 cancelled; fresh required results are not a complete terminal gate and no qualifying approval exists. Decision: `WAIT_AND_REMEDIATE`. |
| [.github#1188](https://github.com/ContextualWisdomLab/.github/pull/1188) | head `3e2dc26eb0659afab7ae41e15586fbcc5f29ed29`, base `fce028b4c3bf8e2e5e4819c1c5622e90cfa6ab39`, merge-result tree `fc41f92f64baf642cfa718a2e69072a048ae5b9f` | The head advanced after the prior OIDC-caller validation, so previous local evidence is stale and is not reused. Latest hosted rollup is 8 success, 13 skipped, with 15 queued/in-progress results; no qualifying approval exists. Decision: `WAIT_AND_REMEDIATE` pending exact-head local verification, terminal required Checks, and normal approval. |
| [.github#1189](https://github.com/ContextualWisdomLab/.github/pull/1189) | head `6ffdcc3f0c96610295d143a3f54f3821b3a23ec9`, base `fce028b4c3bf8e2e5e4819c1c5622e90cfa6ab39`, merge-result tree `798f45a3de691f41b83a7edd241143e15bd6d035` | Exact current-head evidence: `1308 passed`, statement/branch coverage `8128/3144, 100%`, interrogate `100%`, compileall, changed shell syntax, hash-locked pip-audit, and diff-check clean; no workflow files changed. Hosted rollup observed 21 success, 15 skipped, 3 neutral, and 6 queued/in-progress results; no qualifying approval exists. Decision: `WAIT_AND_REMEDIATE` pending terminal required Checks and normal approval. |
...
| [#818](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/818) | head `51531d0c1144427c67649da3233bcbe1c5d53858`, base `e226e1197bdfc890c9d8e5b9b648c78857d7e465` | Open and mergeable but blocked; hosted checks are 15 success, 10 skipped, 2 neutral, and failures in `osv-scan` and `strix`. OSV scanner itself exited `0`, then the workflow postcondition `test -s old-results.json` / `test -s new-results.json` failed on empty no-finding output; Strix failed closed after provider/failure-signal output. These are not proof of a source defect, but they are not cleared evidence; formal approvals `0`. Decision: `WAIT_AND_REMEDIATE`; rerun after the central gate repair and independently disposition Strix output. |
...
| [#820](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/820) | head `4959e805c5724e7d1620639ab0151a992d717a0c`, base `e226e1197bdfc890c9d8e5b9b648c78857d7e465` | Open and mergeable but blocked; hosted checks are 15 success, 10 skipped, 2 neutral, 1 `osv-scan` failure, and `opencode-review` queued. OSV scanner exited `0`, then the workflow postcondition failed because its empty output files were not non-empty; this is the inherited central gate contract, not the sampling-default diff. Formal approvals `0`, auto-merge disabled. Decision: `WAIT_AND_REMEDIATE`; rerun after the central gate repair. |
