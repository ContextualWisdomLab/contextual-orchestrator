...
|---:|---|---|---|
| [#797](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/797) | `2693c01b79c564db041abc930f3365eddd74dfe3` | ready, based on main | Hourly target-repository caller invokes the central reusable review/fix workflow with `max_prs=1`, `max_dispatches=1`, conflict resolution enabled, and no `COPILOT_GITHUB_TOKEN`; the central gateway migration and target #790 remain external prerequisites. Exact local proof is focused `2 passed`, `actionlint`, and diff-check clean; hosted Checks and independent approval remain required. |
...
observed at 2026-08-21 07:39 Asia/Seoul; they are evidence pointers, not
standing approval.
