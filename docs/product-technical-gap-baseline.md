...
| [#834](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/834) | head `9c02b199f14936b258bc05aab71fb427ebc215a9`, base `main` `6970dbb9e63b9bd1ec602bb8c3c85e3a05480424` | Open with normal auto-merge enabled. Zen availability is joined to Models.dev structured cost/modality evidence without name inference. Normalized catalog reload distinguishes provider-declared `capability:*` evidence from generic serving-role tags and preserves cost/modality evidence. Explicitly excluded embedding deployments fail closed; operator-declared Bytez endpoint capabilities survive discovery without model-name inference. PATCH/DELETE now share the GET `model_group_not_found` contract, and the re-read PRD now covers model groups and all supported modalities. Focused evidence includes `92 passed`, `59 passed`, `48 passed`, and the subsequent HTTP regression; hosted Checks and independent exact-head approval remain authoritative. Decision: `WAIT_AND_REMEDIATE`. |
...
| #834 | `9c02b199f14936b258bc05aab71fb427ebc215a9` | `6970dbb9e63b9bd1ec602bb8c3c85e3a05480424` | `BLOCKED`, auto-merge enabled; PRD and missing-group REST contract normalized |
