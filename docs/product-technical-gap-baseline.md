...
| --- | --- | --- |
| [#849](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/849) | `3bb14aff9fe9802a025e95add034a84846547a69` | k6 measured 64 concurrent inference requests: 128/128 inference and 100/100 health requests succeeded with 0/228 HTTP failures at 25.068 inference req/s and 10.85 ms health p99. HTTP/1.1 persistence plus native `socket.SOMAXCONN` raised the initial measured inference rate by 54.61%; rejected unread bodies close the connection and incomplete headers now expire within the configured abuse-accounting window. Independent review and protected checks remain pending with auto-merge enabled. |
...
| [#834](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/834) | `550c988342b29e990eacae108e1b14e5677aacbb` | Contains the reviewed #847 remediation, a model-group fetch failure guard for the admin console, removal of the retired policy-field dependency, and the hourly loop's explicit PRD plus measured-k6 requirement; independent exact-head review and protected checks are pending with auto-merge enabled. This is not protected-main evidence yet. |
