...
**As of:** 2026-08-21 16:50, Asia/Seoul
...
| [#805](https://github.com/ContextualWisdomLab/contextual-orchestrator/pull/805) | `02e306d9be63c42baea8c88fd017a8c4dbae1fc5` | open, based on main; required Checks queued at snapshot | Structured provider-feature orchestration repair. Exact-head local evidence is `1448 passed in 533.62s`; request sampling is thread-local, Responses prefers native `max_output_tokens`, ordinary passthrough usage persists to the spend ledger, and the self-modifying repair workflow/scripts were removed. Current hosted Checks are queued, all current review threads are resolved, and independent approval remains required. |
