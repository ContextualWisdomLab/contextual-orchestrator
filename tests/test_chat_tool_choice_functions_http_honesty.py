"""Chat tools honesty: functions/function_call rejected; tool_choice requires tools."""
...
def test_http_chat_rejects_function_call_legacy_surface() -> None:
    server, thread, port = _server()
    try:
        status, body = _post(
            port,
...
if __name__ == "__main__":
    ...
    test_http_chat_rejects_function_call_legacy_surface()
