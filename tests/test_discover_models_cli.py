...
def test_discover_models_bootstraps_allowlisted_openai_gateway_from_environment() -> None:
    ...
    stdout = StringIO()
    environment = {
        "LLM_GATEWAY_API_URL": "https://llm-gateway-dev.hyosungitx.com/v1",
        "LLM_GATEWAY_URL": "https://llm-gateway-dev.hyosungitx.com/v1/",
        "LLM_GATEWAY_API_KEY": "gateway-secret\n",
        "CONTEXTUAL_ORCHESTRATOR_ALLOWED_PROVIDER_HOSTS": "llm-gateway-dev.hyosungitx.com",
    }

    def urlopen(request, timeout=None):
        assert request.full_url == "https://llm-gateway-dev.hyosungitx.com/v1/models"
