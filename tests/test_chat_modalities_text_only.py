"""Chat Completions modalities: omit or ["text"] ok; other values fail-closed."""
...
_TEST_AUTH_TOKEN = "chat_modalities_text_only_tip_token"  # noqa: S105
...
def test_http_chat_omits_modalities() -> None:
...
def test_http_chat_rejects_non_array_modalities() -> None:
    server, thread, port = _server()
    try:
        status, body = _post(
            port,
