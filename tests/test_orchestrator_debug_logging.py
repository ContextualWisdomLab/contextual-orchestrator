...
def test_send_with_retry_debug_logs_omit_secret_shaped_error_message() -> None:
    """Only typed metadata survives; even partially redacted provider text is omitted."""
