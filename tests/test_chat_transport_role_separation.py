"""Regression tests for chat transport compatibility versus agent-role eligibility."""
...
def test_chat_served_models_remain_transport_compatible(model_id: str) -> None:
    """Do not reject models that provider contracts serve through chat completions."""
