...
- `/healthz` is a minimal unauthenticated process probe; use authenticated `/readyz` for secret-free orchestration, sync-routing, and optional batch dependency status. Liveness stays available during optional dependency degradation.
